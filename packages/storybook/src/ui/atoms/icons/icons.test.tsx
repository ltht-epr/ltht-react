...
describe('All icons', () => {
  ...
  it.each([
    ...
    [<ChevronCircleIcon size="small" data-testid="icon" direction="up" />, 'icon__chevron-circle--up'],
    [<ChevronCircleIcon size="small" data-testid="icon" direction="down" />, 'icon__chevron-circle--down'],
    [<ChevronCircleIcon size="small" data-testid="icon" direction="left" />, 'icon__chevron-circle--left'],
    [<ChevronCircleIcon size="small" data-testid="icon" direction="right" />, 'icon__chevron-circle--right'],
    [<ChevronIcon size="small" data-testid="icon" direction="up" />, 'icon__chevron--up'],
    [<ChevronIcon size="small" data-testid="icon" direction="down" />, 'icon__chevron--down'],
    [<ChevronIcon size="small" data-testid="icon" direction="left" />, 'icon__chevron--left'],
    [<ChevronIcon size="small" data-testid="icon" direction="right" />, 'icon__chevron--right'],
  ...
  it.each([
    ...
    [
      ...
      'icon__chevron-circle--up',
    ],
    [<ChevronIcon size="small" data-testid="icon" direction="up" className="further-maths" />, 'icon__chevron--up'],
