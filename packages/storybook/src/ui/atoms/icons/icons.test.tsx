...
describe('All icons', () => {
  it.each([
    ...
    [<ArrowIcon size="small" direction="up" />],
  ...
  it.each([
    ...
    [<ChevronCircleIcon size="small" direction="up" />, 'icon__chevron-circle--up'],
    [<ChevronCircleIcon size="small" direction="down" />, 'icon__chevron-circle--down'],
    [<ChevronCircleIcon size="small" direction="left" />, 'icon__chevron-circle--left'],
    [<ChevronCircleIcon size="small" direction="right" />, 'icon__chevron-circle--right'],
    [<ChevronIcon size="small" direction="up" />, 'icon__chevron--up'],
    [<ChevronIcon size="small" direction="down" />, 'icon__chevron--down'],
    [<ChevronIcon size="small" direction="left" />, 'icon__chevron--left'],
    [<ChevronIcon size="small" direction="right" />, 'icon__chevron--right'],
    ...
    [<ChevronDoubleIcon size="small" direction="up" />, 'icon__chevron-double--up'],
    [<ChevronDoubleIcon size="small" direction="down" />, 'icon__chevron-double--down'],
    [<ChevronDoubleIcon size="small" direction="left" />, 'icon__chevron-double--left'],
    [<ChevronDoubleIcon size="small" direction="right" />, 'icon__chevron-double--right'],
    [<ArrowIcon size="small" direction="up" />, 'icon__arrow--up'],
    [<ArrowIcon size="small" direction="down" />, 'icon__arrow--down'],
    [<ArrowIcon size="small" direction="left" />, 'icon__arrow--left'],
    [<ArrowIcon size="small" direction="right" />, 'icon__arrow--right'],
  ...
  it.each([
    ...
    [<ChevronCircleIcon size="small" direction="up" className="further-maths" />, 'icon__chevron-circle--up'],
    [<ChevronIcon size="small" direction="up" className="further-maths" />, 'icon__chevron--up'],
    ...
    [<ChevronDoubleIcon size="small" direction="up" className="further-maths" />, 'icon__chevron-double--up'],
    [<ArrowIcon size="small" direction="up" className="further-maths" />, 'icon__arrow--up'],
  ...
  it.each([
    ...
    [<ChevronDoubleIcon size="small" direction="up" id="123abc" />],
    [<ArrowIcon size="small" direction="up" id="123abc" />],
