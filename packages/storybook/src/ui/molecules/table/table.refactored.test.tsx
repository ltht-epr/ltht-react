...
import ReFactoredTable from '@ltht-react/table'
...
describe('Simple Table', () => {
  beforeEach(() => {
    render(<ReFactoredTable tableData={mockTableData} />)
  })
...
describe('Table With Subheaders', () => {
  beforeEach(() => {
    render(<ReFactoredTable tableData={mockTableDataWithSubheaders} />)
  })
