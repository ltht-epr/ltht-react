...
export const summaryDefinitionOneVerticalTableDataWithCustomCellRendering: TableData = {
  headers: [
    {
      accessor: 'property',
      header: '',
    ...
    },
    {
      accessor: '3',
      header: '01-Jan-2022 16:02',
      cell: (v) => <span style={{ border: '1px solid red' }}>{v}</span>,
    },
  ],
  rows: [
    {
...
export const customRenderCellsVertical = summaryDefinitionOneVerticalTableDataWithCustomCellRendering.headers
  .filter((x) => x.cell)
  .map((x) => ({ id: x.accessor, render: x.cell } as CellRender))
...
export const customRenderCellsHorizontal: CellRender[] = [
  {
    id: '3',
    render: (v) => <b>{v}</b>,
  },
...
export const summaryDefinitionOneHorizontalTableDataWithCustomCellRendering: TableData = {
  headers: [
    {
      accessor: 'date',
      header: 'Record Date',
