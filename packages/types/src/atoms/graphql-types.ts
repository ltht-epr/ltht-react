...
export type Address = {
  ...
  /**
   * Street name, number, direction & P.O. Box etc. This repeating element order:
...
export type HumanName = {
   ...
   * element order: Given Names appear in the correct order for presenting the name.
   */
  given?: Maybe<Array<Maybe<Scalars['String']>>>
  /** Time period when name was/is in use. */
  period?: Maybe<Period>
  /**
   * Parts that come before the name. This repeating element order: Prefixes appear
   * in the correct order for presenting the name.
   */
  prefix?: Maybe<Array<Maybe<Scalars['String']>>>
  /**
   * Parts that come after the name. This repeating element order: Suffixes appear
   * in the correct order for presenting the name.
   */
...
export type PatientContact = {
  ...
  period?: Maybe<Period>
  /**
   * The nature of the relationship between a patient and a contact person for that
   * patient. http://hl7.org/fhir/stu3/ValueSet/v2-0131
   */
...
/**
 * Data that comes from a series of measurements taken by a device, which may have
 * upper and lower limits. The data type also supports more than one dimension in the data.
 */
