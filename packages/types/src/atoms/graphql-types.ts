...
export type Ehr = {
  ...
  /** Gets all open countersignature requests for a patient */
  countersignatureRequestsForPatient?: Maybe<QuestionnaireResponseContinuation>;
...
export type EhrClinicalDataHistoryForPatientByUserArgs = {
  ...
  from?: Maybe<Scalars['DateTimeOffset']>;
  patientGuid: Scalars['Guid'];
  professionGroup?: Maybe<ProfessionGroup>;
...
/** Queries the LTHT EHR. */
export type EhrCountersignatureRequestsForPatientArgs = {
  count?: Maybe<Scalars['Int']>;
  cursorToken?: Maybe<Scalars['String']>;
  from?: Maybe<Scalars['DateTimeOffset']>;
  patientGuid: Scalars['Guid'];
...
export enum EntityType {
  ...
  Contact = 'CONTACT',
  CustomListAdhocTasks = 'CUSTOM_LIST_ADHOC_TASKS',
...
export enum FeatureInstance {
  ...
  AssessmentRecordLabTestResultsEnabled = 'ASSESSMENT_RECORD_LAB_TEST_RESULTS_ENABLED',
  ...
  EdanInteractiveDiagnosisEnabled = 'EDAN_INTERACTIVE_DIAGNOSIS_ENABLED',
  ...
  FullScreenWidgetsEnabled = 'FULL_SCREEN_WIDGETS_ENABLED',
