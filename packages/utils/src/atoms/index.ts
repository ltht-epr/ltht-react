...
export { default as isTabletView } from './isTabletView'
export { default as isDesktopView } from './isDesktopView'
export { default as isWidescreenView } from './isWidescreenView'
