...
const QuestionnaireTable: FC<IProps> = ({ definition, records, headerAxis = 'y', stickColumns = 1, adminActions }) => {
  ...
  return <Table tableData={tableData} stickColumns={stickColumns} />
}
