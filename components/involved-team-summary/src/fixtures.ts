...
const InvolvedTeamOne: EpisodeOfCare = {
  ...
  team: [{ display: 'LYPFT Outbound Care Team', type: 'Test Team' }],
  period: {
    start: {
  ...
  careManager: { display: 'Bella Swann (0113 111111)', type: 'Care Manager' },
  type: [
    {
...
const InvolvedTeamTwo: EpisodeOfCare = {
  ...
  metadata: mockMetadata,
  team: [{ display: 'LYPFT Inbound Care Team', type: 'Test Team' }],
  period: {
    start: {
  ...
  careManager: { display: 'Joe Bloggs (0113 000000)', type: 'Care Manager' },
  type: [
    {
